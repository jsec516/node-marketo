...
List.prototype = {
  ...
  addLeadsToList: function(listId, input) {
    ...
    var path = util.createRestPath('lists', listId, 'leads.json');
  ...
  getLeads: function(listId, options) {
    var path = util.createRestPath('list', listId, 'leads.json');
    options = _.extend({}, options, {
      listId: listId,
      _method: 'GET'
    });
  ...
  isMember: function(listId, leadIds) {
    ...
    var path = util.createRestPath('lists', listId, 'leads', 'ismember.json');
