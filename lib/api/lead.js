...
var LEADS = util.createRestPath('leads.json');
...
Lead.prototype = {
  byId: function(id, options) {
    var path = util.createRestPath('lead', id + '.json');
  ...
  associateLead: function(leadId, cookieId) {
    var path = util.createRestPath('leads', leadId, 'associate.json');
    return this._connection.postJson(path, {}, {query: {cookie: cookieId}});
  },

  describe: function() {
    var path = util.createRestPath('leads', 'describe.json');
    return this._connection.get(path);
  },

  partitions: function() {
    var path = util.createRestPath('leads', 'partitions.json');
    return this._connection.get(path);
  },
  ...
  mergeLead: function(winningLead, losingLeads, options) {
    ...
    var path = util.createRestPath('leads', winningLead, 'merge.json');
  ...
  getPageToken: function(sinceDatetime, options) {
    var path = util.createRestPath('activities','pagingtoken.json');
    options = _.extend({}, options, {
  ...
  getActivitiesWithOptions: function(options) {
    options._method = 'GET'
    var path = util.createRestPath('activities.json');
    options = util.formatOptions(options);
    return this._connection.post(path, {data: options});
  },
  ...
  getChangesWithOptions: function(options) {
    options._method = 'GET'
    var path = util.createRestPath('activities','leadchanges.json');
    options = util.formatOptions(options);
    return this._connection.post(path, {data: options});
  },
